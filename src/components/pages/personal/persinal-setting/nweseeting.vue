<template>
  <div style="background:#f3f3f3;">
    ...
    <div class="bodydiv">
      ...
      <!-- 籍贯所在地 -->
      <!-- <van-field v-model="newdata.location" clearable label="籍贯所在地" placeholder="籍贯所在地"/> -->
      <div class="setdiv">
    ...
    <div class="bodydiv">
      ...
      <!-- 微信 -->
      <!-- <van-field v-model="newdata.weixin" required clearable label="微信" placeholder="微信"/> -->
      <div class="setdiv">
...
export default {
  ...
  methods: {
    ...
    axiosReisteruser() {
      //登录方法
      // Toast.success("进入函数" + apis);

      axios({
        url: urlapi.login,
        method: "post",
        data: {
          username: this.newdata.phonenumber,
          password: this.newdata.password
        }
      })
        .then(res => {
